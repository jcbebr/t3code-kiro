...
describe("RPC authorization scopes", () => {
  ...
  it("allows reading Kiro agent choices without granting provider configuration access", () => {
    expect(requiredScopeForRpcMethod(WS_METHODS.serverGetKiroAgents)).toBe(
      AuthOrchestrationReadScope,
    );
